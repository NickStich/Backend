...
public class OperationTeeth {
    ...
    public OperationTeeth(int id, String medic, String patient, WorkType worktype, int teethNr) {
        ...
        Timeea timeea = new Timeea();
        Paula paula = new Paula();
        Emi emi = new Emi();

        setTimeea(this.teethNr * EmployeeStrategy.distributeToEmployees(timeea, this.worktype));
        setPaula(this.teethNr * EmployeeStrategy.distributeToEmployees(paula, this.worktype));
        setEmi(this.teethNr * EmployeeStrategy.distributeToEmployees(emi, this.worktype));
